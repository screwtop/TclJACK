...
load ./libtcljack.so
jack_register
puts "JACK sampling rate = [jack_samplerate] Hz"
...
#	set k [expr {1 / (pow(1 / sqrt(2), 0.67))}]	;# Full-scale sine wave = 1.0; probably the loudest reasonable singal you'd expect to see.
...
set nmax 10
every 50 {sound_gauge_update [jack_meter]}; if {[incr ::nmax -1]<=0} return}
